...
int main (int argc , char*argv[]){ // o problema foi resolvido usando o crivo de eratostenes
    ...
    int lista[n], raiz = sqrt(n);  // A variavel "raiz" recebe a parte inteira da raiz quadrada do numero N digitado
                                    //Exemplo: se N=30 ,raiz=5
                                    //a variavel "raiz" serve para delimitar quais os multiplos que ser�o eliminados(nesse caso zerados) do vetor lista
