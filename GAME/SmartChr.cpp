/*
    Arquivo com os métodos da classe SmartChar, responsável por verificar a válidade da tentativa gerada pelo computador quando ele estiver 
    jogando, caractere a caractere
